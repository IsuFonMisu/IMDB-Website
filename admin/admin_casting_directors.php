...
<html>
    ...
    <head>
        ...
        <title>Admin Casting Directors</title>
	...
	<body>
		...
		<div class = "myDiv">
			<?php
				include "casting_director_table.php";
			?>
		</div>

		<div class ="myDiv2">
			<b> Adding Casting Directors </b>
			<form action="admin_add.php" method="POST">
			  	<input type="text" id="name" name="casting_director" placeholder="Type Casting Directors's name"><br>

			  	<input type="text" id="ssn" name="ssn" placeholder="Type Casting Director's SSN"><br>
