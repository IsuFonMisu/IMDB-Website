...
<html>
	...
	<body>
		...
		<div class ="myDiv2">
			<b> Adding Directors </b>
			<form action="admin_add.php" method="POST">
			  	<input type="text" id="name" name="director_name" placeholder="Type Director's name"><br>

			  	<input type="text" id="ssn" name="ssn" placeholder="Type Director's SSN"><br>
