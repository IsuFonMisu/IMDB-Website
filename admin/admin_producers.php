...
<html>
	...
	<body>
		...
		<div class ="myDiv2">
			<b> Adding Producers </b>
			<form action="admin_add.php" method="POST">
			  	<input type="text" id="name" name="producer_name" placeholder="Type Producer's name"><br>

			  	<input type="text" id="ssn" name="ssn" placeholder="Type Producer's SSN"><br>
